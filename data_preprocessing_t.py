...
# desc = desc['features']
#lap_pos = read_pickle("../DAS-DDI/dataset/trans/drugbank/drug_pos_data.pkl")
drug_dgl = read_pickle("../DAS-DDI/dataset/trans/drugbank/drug_dgl_data_zhang.pkl")
drugbank_similarity = read_pickle("../DAS-DDI/dataset/trans/drugbank/drug_similarity_zhang.pkl")
#drugbank_association = read_pickle('../DAS-DDI/dataset/trans/drugbank/drugbank_association_matrix.pkl')
ID_index = read_pickle('../DAS-DDI/dataset/trans/drugbank/ID_index.pkl')
drug_ID = ID_index
